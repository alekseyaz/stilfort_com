...
<xsl:stylesheet version="1.0" xmlns:xsl="http://www.w3.org/1999/XSL/Transform">
    ...
    <xsl:template match="status_notification">
        ...
        <xsl:variable name="address-string" select="concat($customer//property[@name='city']/value,', ',$customer//property[@name='ulica']/value,', ',$customer//property[@name='indeks']/value,', д. ',$customer//property[@name='dom']/value,', корп.',$customer//property[@name='korp']/value,', кв.',$customer//property[@name='kvartira']/value)" />

        <xsl:choose>
            <xsl:when test="$order//property[@name='status_id']/value/item/@name = 'Ожидает проверки'">    <!-- 18 статус заказа: ожидает проверки -->
                ...
                <h4 style="background: #cdcdcd; padding-bottom: 0; margin-bottom: 0; font-size: 14px; width: 800px">Информация о покупателе</h4>
                    ...
                    <tr>
                        <td width="50%; text-align: left">
                            ...
                            <table width="100%" cellpadding="0" cellspacing="0" style="width: 100%">
                                ...
                                <xsl:choose>
                                    <xsl:when test="$customer//property[@name='phone_or_email']//value != ''">
                                        <tr>
                                            <td width="50%; text-align: left">
                                                <xsl:text>Телефон или e-mail:</xsl:text>
                                            </td>
                                            <td>
                                                <xsl:value-of select="$customer//property[@name='phone_or_email']//value" />
                                            </td>
                                        </tr>
                                    </xsl:when>
                                    <xsl:otherwise>
                                        <tr>
                                            ...
                                            <td>
                                                <xsl:value-of select="$customer//property[@name='phone']//value" />
                                            </td>
                                        </tr>
                                        <tr>
                                            <td width="50%; text-align: left">
                        ...
                        <xsl:if test="not($customer//property[@name='phone_or_email']//value) and $order//property[@name='delivery_id']//value/item/@name != 'Самовывоз'">
                            <td width="50%" valign="top">
                                ...
                                <table width="100%" cellpadding="0" cellspacing="0" style="width: 100%">
                                    ...
                                    <xsl:if test="$customer//property[@name='kommentarij']//value != ''">
                                        <tr>
                                            <td width="50%; text-align: left">
                                                <xsl:text>Комментарий:</xsl:text>
                                            </td>
                                            <td>
                                                <xsl:value-of select="$customer//property[@name='kommentarij']//value" />
                                            </td>
                                        </tr>
                                    </xsl:if>
                                </table>
            ...
            <xsl:when test="$order//property[@name='status_id']/value/item/@id = '18'">
                ...
                <table cellpadding="0" cellspacing="0" border="0" style="width:800px">
                    ...
                    <tr>
                        ...
                        <td width="50%">
                            <xsl:value-of select="$order//property[@name='payment_id']//value/item/@name" /> (<a href="http://{domain}/emarket/receipt/{order_id}/{receipt_signature}/">
                                <xsl:text>печать квитанции на оплату</xsl:text>
                            </a>)</td>
                    </tr>
                    <tr>
                        <td width="50%; text-align: left">
    ...
    <xsl:template match="item" mode="order-item">
        ...
        <tr>
            ...
            <td style="text-align: left">
                ...
                <xsl:value-of select="$item//property[@name='item_price']//value" />&#160;руб.
            </td>
            <td style="text-align: left">
                <xsl:value-of select="$item//property[@name='item_amount']//value" />
            </td>
            <td style="text-align: left">
                <xsl:value-of select="$item//property[@name='item_total_price']//value" />&#160;руб.
            </td>
        </tr>
