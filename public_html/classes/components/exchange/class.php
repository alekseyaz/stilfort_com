	...
	class exchange extends def_module {
		...
		public function getTranslatorSettings() {
			...
			$translator_settings[] = [
				...
				'node:value' => $this->isNeedToRestoreCatalogItemsFromTrashInCML()
			];
			$translator_settings[] = [
				'attribute:key' => 'is_change_catalog_item_h1_from_cml',
				'node:value' => $this->isChangeCatalogItemH1InCML()
			];
			$translator_settings[] = [
				'attribute:key' => 'is_change_catalog_item_title_from_cml',
				'node:value' => $this->isChangeCatalogItemTitleInCML()
			];
		...
		public function isChangeCatalogItemH1InCML() {
			return (int) $this->getRegistry()
				->get("//modules/exchange/is_change_catalog_item_h1_from_cml");
		}
		...
		public function setChangeCatalogItemH1InCML($status) {
			$this->getRegistry()
				->set("//modules/exchange/is_change_catalog_item_h1_from_cml", (int) $status);
			return $this;
		}
		...
		public function isChangeCatalogItemTitleInCML() {
			return (int) $this->getRegistry()
				->get("//modules/exchange/is_change_catalog_item_title_from_cml");
		}
		...
		public function setChangeCatalogItemTitleInCML($status) {
			$this->getRegistry()
				->set("//modules/exchange/is_change_catalog_item_title_from_cml", (int) $status);
			return $this;
		}
